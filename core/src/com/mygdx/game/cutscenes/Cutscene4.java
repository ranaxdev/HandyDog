...
public class Cutscene4 implements Screen {
    ...
    //Actors
    Image pic = new Image(GameJam.assets.manager.get(Assets.memory3));
    Label text1 = new Label("w0w friend", new Label.LabelStyle(font, Color.WHITE));
    Label text2 = new Label("that smells good", new Label.LabelStyle(font, Color.WHITE));
    Label text3 = new Label("gib pls", new Label.LabelStyle(font, Color.WHITE));
    Label text4 = new Label("no? ok :(", new Label.LabelStyle(font, Color.WHITE));
    OrthographicCamera cam;
    public Cutscene4(GameJam game, MainGameScreen main) {
        this.main = main;
        this.game = game;
