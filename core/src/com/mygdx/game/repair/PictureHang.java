...
public class PictureHang implements Screen {
    ...
    //entities
    Picture picture;
    public PictureHang(GameJam game, MainGameScreen main){
        this.game=game;
        this.main=main;
    }
    //TEMP
    ...
    public void render(float delta) {
        //Update logic
        //Update plank logic
        cam.unproject(picture.boundClickPos);
        ...
        cam.unproject(picture.clickPos);
        //Draw
